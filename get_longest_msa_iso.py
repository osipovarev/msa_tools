...
def main():
    ...
    parser.add_argument('-d', '--msadir', type=str, help='dir with all transcript MSAs sorted by gene, like run_by_gene/ANKRD1/ENSGAL0000*.fa')
    ...
    gene_msa_dict = {g: glob(g + '/*' + suf) for g in gene_dirs_list if len(glob(g + '/*' + suf)) > 0}
