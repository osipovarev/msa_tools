...
def main():
    ...
    parser.add_argument('-mc', '--mincodon', type=float, default=0.8, help='min codon fraction to align for a column to stay; default: 0.8')
    parser.add_argument('-ms', '--minseq', type=float, default=0.3, help='min sequence fraction to align for it to stay; default: 0.3')
